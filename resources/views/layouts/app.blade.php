                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="/settings"><i
                                    class="bx bxs-cog font-size-16 align-middle me-1"></i>
                                <span key="t-profile">Settings</span></a>
                    ...
                    <ul class="metismenu list-unstyled" id="">
                        ...
                        <li>
                            <a href="{{ route('academic.year') }}" class="waves-effect">
                                ...
                                <span key="t-calendar">Academic Year</span>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('classes.index') }}" class="waves-effect">
                                ...
                                <span key="t-calendar">Classes</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('subject.index') }}" class="waves-effect">
                                <i class="bx bx-book"></i>
                                <span key="t-calendar">Subjects</span>
                            </a>
                        </li>
                        <li>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">
                                <li>
                                    <a href="/users" key="t-light-sidebar">
                                        <span>
                                            Users
                                        </span>
                                    </a>
                                ...
                                <li>
                                    <a href="/roles" key="t-compact-sidebar">
                                        <span>
                                            Roles
                                        </span>
                                    </a>
