                    ...
                    <form id="recordForm">
                        ...
                        <div class="row g-2">
                            <div class="mb-2 col-md-12 mt-0">
                                ...
                                <div class='text-danger' id="short_name-error"></div>
                            </div>
                            <div class="mb-2 col-md-12 mt-0">
            ...
            $(document).ready(function() {
                ...
                let table = $('#dataTable').DataTable({
                    ...
                    columns: [{
                            ...
                            searchable: true,
                            orderable: false,
                            render: function(rowData, _, data, row) {
                                return `
                                    <h4 class="my-0">${rowData}</h4>
                ...
                $('#btnSave').click(function() {
                    ...
                    axios.post(`/department/store`, data).then((response) => {
                        if (response.status === 200) {
                            //swal({
                ...
                $('#btnSaveChanges').click(function() {
                    let id = $(this).attr('data-key');
                    let data = $('#recordForm').serialize();
                    axios.put(`/department/${id}`, data).then((response) => {
                        if (response.status === 200) {
                            table.ajax.reload(null, false);
                            //swal({
